			...
			<section id="first">
				<div class="container right-down">
					...
					<div class="tab-content">
						...
						<!-- =============================分頁1 =========================內容 -->
						<div class="tab-pane" id="rpt-1-1">
							<div class="row search">
								<div class="col-md-12">

									<h4>
										<a href="listAllPromotion.jsp" style="color: orange;">列出</a>所有資料
									</h4>
									<br>
							...
							<div>
								<table border=1 rules="rows" class="table ">
									...
									<tbody>
										...
										<!--跌代出list -->
										<c:forEach var="promotionItemVO" items="${list1}"
											begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">

											<tr>
												<td>${promotionItemVO.promotion_id}</td>
												<td>${promotionItemVO.room_type_id}</td>
												<td>${promotionItemVO.discount_number}</td>
												<!-- 												<td><FORM METHOD="post" -->
												<%-- 														ACTION="<%=request.getContextPath()%>/back_end/promotionItem/promotionItem.do" --%>
												<!-- 														style="margin-bottom: 0px;"> -->
												<!-- 														<input type="submit" value="修改"> <input type="hidden" name="promotion_id" -->
												<%-- 															value="${promotionVO.promotion_id}"> <input --%>
												<!-- 															type="hidden" name="action" value="getOne_For_Update_PromotionItem"> -->
												<!-- 													</FORM></td> -->
