					...
					<div class="tab-content">
									...
									<tbody>
										<c:forEach var="articleReportVO" items="${listArticleReport}">
											<tr>
												...
												<td><c:choose>
														<c:when
															test="${articleReportVO.article_reportprocess_state==0}">
												         尚未處理
												</c:when>
														<c:when
															test="${articleReportVO.article_reportprocess_state==1}">
													   屏蔽文章內容
												</c:when>
														<c:when
															test="${articleReportVO.article_reportprocess_state==2}">
													  不屏蔽文章內容
												</c:when>
													</c:choose></td>
												<td><fmt:formatDate
														value="${articleReportVO.article_reportprocess_time}"
												...
												<td>
													<form method="post" action="articleReport.do">
														...
														<input type="hidden" name="article_report_id"
															value="${articleReportVO.article_report_id}">
						...
						<div class="tab-pane" id="tab-2">
							...
							<form method="post" action="articleReport.do">
								...
								<div class="row">
									<div class="col-md-12">
										<span>•文章檢舉事由:</span> <span> <c:choose>
												<c:when test="${articleReportVO.article_report_reason==0}">
												惡意洗版、重複張貼
												</c:when>
												<c:when test="${articleReportVO.article_report_reason==1}">
								...
								<div class="row">
									<div class="col-md-12">
										<span>•文章檢舉處理狀態:</span><span> <c:choose>
												<c:when
													test="${articleReportVO.article_reportprocess_state==0}">
												         尚未處理
												</c:when>
								...
								<div class="row">
									<div class="col-md-12">
										<textarea class="rArticle-text" rows="2"
											name="article_reportprocess_content"> ${articleReportVO.article_reportprocess_content} </textarea>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-12">
										<input class="dealDate" type="text"
											name="article_reportprocess_time">
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<input type="hidden" name="article_id"
											value="${articleReportVO.article_id}"> <input
											type="hidden" name="emp_id" value="1">
										<button type="submit" class="btn btn-primary rArticle-btn">
											送出處理</button>
									</div>
								</div>
									...
									<tbody>
										<c:forEach var="commentReportVO" items="${listCommetReport}">
											<tr>
												...
												<td><c:choose>
														<c:when
															test="${commentReportVO.comment_reportprocess_state==0}">
												         尚未處理
												</c:when>
														<c:when
															test="${commentReportVO.comment_reportprocess_state==1}">
													   屏蔽留言內容
												</c:when>
														<c:when
															test="${commentReportVO.comment_reportprocess_state==2}">
													  不屏蔽留言內容
												</c:when>
													</c:choose></td>
												<th><fmt:formatDate
														value="${commentReportVO.comment_reportprocess_time}"
												...
												<td>
													<form method="post" action="commentReport.do">
														...
														<input type="hidden" name="comment_report_id"
															value="${commentReportVO.comment_report_id}">
						...
						<div class="tab-pane" id="tab-4">
							<form method="post" action="commentReport.do">
								...
								<div class="row">
									<div class="col-md-12">
										<textarea class="rComment-text" rows="2"
											name="comment_reportprocess_content">${commentReportVO.comment_reportprocess_content}</textarea>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-12">
										<input class="dealDate" type="text"
											name="comment_reportprocess_time">
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<input type="hidden" name="comment_id"
											value="${commentReportVO.comment_id}"> <input
											type="hidden" name="emp_id" value="1">
										<button type="submit" class="btn btn-primary rComment-btn">
											送出處理</button>
									</div>
