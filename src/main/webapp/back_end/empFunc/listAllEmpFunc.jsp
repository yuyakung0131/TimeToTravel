			...
			<section id="first">
				<div class="container right-down">
					...
					<div class="nav nav-tabs">
						...
						<!-- 分頁2 -->
						<a href="<%=request.getContextPath()%>/back_end/empFunc/addEmpFunc.jsp" style="text-decoration: none;">
							<button class="nav-link" data-bs-toggle="tab"
								data-bs-target="#tab-2" aria-selected="false">新增員工權限</button>
						</a>
						<!-- 分頁3 -->
					</div>
					<!--  分頁內容，若不要分頁可以整塊刪掉 -->
							...
							<div class="row search">
								<div class="col-md-12">
									<table border=1  class="table ">
										...
										<c:forEach var="empFuncVO" items="${list}"
											...
											<tr>
												...
												<td>
													<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back_end/empFunc/empFunc.do" style="margin-bottom: 0px;">
