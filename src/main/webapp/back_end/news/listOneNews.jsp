...
<jsp:include page="../sidebar.jsp"></jsp:include>
		...
		<div class="nav nav-tabs">
			...
			<button class="nav-link active" data-bs-toggle="tab"
				data-bs-target="#tab-1" aria-selected="true">最新消息單筆查詢</button>
					...
					<table>
						<thead>
							...
							<tr style="border: 1px solid black; width: 400px;"">
								<div class="row">
									...
									<th class=" col-3 fht-cell" data-field="news_time"
						...
						<tbody class=" newscol">
							...
							<tr>
								...
								<td><img src="${pageContext.request.contextPath}/back_end/news/news.do?action=getImg&news_no=${newsVO.news_no}"style="width:300px;"></td>
								<!-- 												圖片未用好 -->
								...
								<td><FORM METHOD="post"
										...
										<input type="submit" value="刪除"> <input type="hidden"
											name="promotion_id" value="${promotionVO.promotion_id}">
