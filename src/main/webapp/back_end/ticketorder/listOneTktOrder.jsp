...
<%
TktOrder tktorder = (TktOrder) request.getAttribute("tktorder");
pageContext.setAttribute("tktorder", tktorder);
%>
					...
					<div class="tab-content">
						...
						<div class="tab-pane show active" id="tab-1">
							...
							<div class="row">
								...
								<!-- 										<select name="action"> -->
								<!-- 											<option value="getTktOrderId_For_Display">訂單編號</option> -->
								<!-- 											<option value="getMemberId_For_Display">會員編號</option> -->
								<!-- 											<option value="getTktOrderState_For_Display">訂單狀態</option> -->
