								...
								<div class="col-md-12">
									<FORM METHOD="post" ACTION="tktorder.do">
												<select name="action" style="text-align: center;">
													...
													<option value="getTktOrderId_For_Display" style="text-align: center;">訂單編號</option>
													<option value="getMemberId_For_Display" style="text-align: center;">會員編號</option>
												</select> 
									...
									<tbody>
										...
										<c:forEach var="tktorder" items="${list}">
											...
											<tr>
												...
												<td>
													<!-- 													<FORM METHOD="post" --> <%-- 														ACTION="<%=request.getContextPath()%>/back_end/ticketorder/tktorder.do" --%>
													<!-- 														style="margin-bottom: 0px;"> --> <!-- 														<input type="submit" value="修改"> <input -->
													<!-- 															type="hidden" name="tkt_order_id" --> <%-- 															value="${tktorder.tkt_order_id}"> <input --%>
													<!-- 															type="hidden" name="action" value="getOne_For_Update"> -->
													<!-- 													</FORM> -->
													<FORM METHOD="post"
														ACTION="<%=request.getContextPath()%>/back_end/ticketorder/tktorder.do"
														style="margin-bottom: 0px;">
														<input type="submit" class="btn-info btn-sm" value="訂單明細">
														<input type="hidden" name="tkt_order_id"
