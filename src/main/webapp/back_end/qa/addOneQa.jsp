							...
							<table>
								<tr>
									...
									<td><input type="TEXT" name="qa_show_no" size="45"
										value="<%=(qavo == null) ? "99" : qavo.getQa_show_no()%>" /></td>
								</tr>
								...
								<tr>
									...
									<td><input type="TEXT" name="question" size="45"
										value="<%=(qavo == null) ? "【其他】test" : qavo.getQuestion()%>" /></td>
								</tr>
								<tr>
									<td>常見問題解答:</td>
									<td><input type="TEXT" name="answer" size="45"
										value="<%=(qavo == null) ? "answer" : qavo.getAnswer()%>" /></td>
								</tr>

								<tr>
									<td>常見問題狀態:</td>
									<td><input type="TEXT" name="qa_state" size="45"
										value="<%=(qavo == null) ? "0" : qavo.getQa_state()%>" /></td>
								</tr>
