...
List<FirmVO> list = firmSvc.getByReviewState();
			...
			<section id="first">
				<div class="container right-down">
					...
					<div class="nav nav-tabs">
						<!-- 分頁1 -->
						<a href="<%=request.getContextPath()%>/back_end/firm/select_page.jsp" style="text-decoration: none;">
							<button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-1" aria-selected="false">查看廠商資料</button>
						</a>
						<!-- 分頁2 -->
						
							<button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tab-2" aria-selected="true">未審核廠商</button>
							...
							<div class="row search">
								<div class="col-md-12">
									<table border=1 class="table ">
										...
										<c:forEach var="firmVO" items="${list}">
										<tr>
