...
<body>
				...
				<div class="container right-down">
					...
					<div class="nav nav-tabs ">
						...
						<button class="nav-link active" data-bs-toggle="tab"
							data-bs-target="#tab-1" aria-selected="true">修改房型</button>
						<!-- 分頁2 -->
						<button class="nav-link" data-bs-toggle="tab"
							data-bs-target="#tab-2" aria-selected="false">搜尋房型</button>
						<!-- 分頁3 -->
						<button class="nav-link" data-bs-toggle="tab"
							data-bs-target="#tab-3" aria-selected="false">新增房型</button>
	...
	<form method="post" action="<%=request.getContextPath()%>/back_end/roomtype/room.do" name="form1">
		<jsp:useBean id="firmSvc" scope="page" class="com.firm.model.FirmService"/>
		<table>
			<tr>
				<td>廠商名稱:</td>
				<td>
				<input type="text" name="firm_name" size="45"
					value="${roomTypeVO.firm_id_byFirm.firm_name }" disabled>
				</td>
			<tr>
				<td>房型名稱:</td>
			...
			<tr>
				...
				<td><input type="number" name="room_type_amount" size="45"
					value="${roomTypeVO.room_type_amount }" disabled></td>
			</tr>
			<tr>
				<td>房型說明:</td>
				<td><input type="text" name="room_type_content" size="45"
					value="${roomTypeVO.room_type_content }" disabled></td>
			</tr>
			<tr>
				<td>房型狀態:</td>
				<td>
				<select name="room_type_state">
				<option  value="0" ${roomTypeVO.room_type_state==0?'selected':''}>上架</option>
				<option  value="1"${roomTypeVO.room_type_state==1?'selected':''}>下架</option>
			...
			<tr>
				...
				<td><input type="text" name="room_type_price" size="45"
					value="${roomTypeVO.room_type_price }" disabled></td>
			</tr>
		</table>
