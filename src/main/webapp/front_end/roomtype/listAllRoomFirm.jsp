...
<%@ page import="com.dateadd.model.*"%>
<%
Timestamp currentDate = new Timestamp(System.currentTimeMillis());
SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
DateAdd dateAdd = new DateAdd();
Timestamp secondDate = dateAdd.addDays(currentDate, 1);
String current_date = dateFormat.format(currentDate).toString();
String second_date = dateFormat.format(secondDate).toString();
pageContext.setAttribute("current_date", current_date);
pageContext.setAttribute("second_date", second_date);
FirmService firmSvc = new FirmService();
List<FirmVO> firmList = firmSvc.getAllRoomFirm();
pageContext.setAttribute("firmList", firmList);
%>
<!DOCTYPE html>
<html lang="en">
						...
						<div class="col-lg-3 ">
							<div class="input-group">
								<input class="form-control" style="font-size: 14px;" id="from"
									name="start_date" placeholder="入住" autocomplete="off" required
									value="${start_date==null?current_date:start_date }"> <input
									class="form-control" style="font-size: 14px;" id="to"
									name="end_date" placeholder="退房" autocomplete="off" required
									value="${end_date==null?second_date:end_date }">
							</div>
						</div>
								...
								<c:forEach var="firmVO" items="${firmList}">
									<form
										...
										<input type="hidden" name="room_firm_id"
											...
											name="action" value="roomType_view"> <input
