						...
						<div class="mc-box2 col-lg-12">
							<div class="profile-list">
								<ul class="list-unstyled">
									<li><a class="active" href="${pageContext.request.contextPath}/front_end/member/member.do?action=clickMemberCenter&member_email=${memberVO.member_email}" class="member_center"><i
											class="fa fa-solid fa-gear"></i>帳號設定</a></li>
									<li><a
										href="<%=request.getContextPath()%>/front_end/member/Orderlist.jsp"
										><i class="fa fa-file-text"></i>訂單管理</a></li>
					...
					<div class="mc-table col-lg-9 co1-sm-12">
						<div class="col-lg-12 mc-box3">
							<div class="profile-info " style="overflow-y:scroll ;overflow-x:hidden ;">
									...
									<div class="col-lg-12">
										<nav class="sub-title">
											<div class="nav nav-tabs" id="nav-tab" role="tablist">
												<a class="nav-item nav-link active" id="nav-member-info-tab"
													data-toggle="tab" href="#nav-member-info" role="tab"
													aria-controls="nav-member-info" aria-selected="true">基本資料</a>
												<a class="nav-item nav-link" id="nav-pwd-info-tab"
													data-toggle="tab" href="#nav-pwd-info" role="tab"
													aria-controls="nav-pwd-info" aria-selected="false">帳號安全</a>
											</div>
										</nav>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent" id="nav-tabContent-membercenter">
											<!--change info start-->
											<div class="tab-pane fade show active member-info"
												id="nav-member-info" role="tabpanel"
												aria-labelledby="nav-member-info">
												<form Method="post"
													action="<%=request.getContextPath()%>/front_end/member/member.do">
											...
											<div class="tab-pane fade password-info" id="nav-pwd-info"
												role="tabpanel" aria-labelledby="nav-pwd-info">
												<form Method="post"
													action="<%=request.getContextPath()%>/front_end/member/member.do">
													<!-- hidden input which is servlet find action -->
