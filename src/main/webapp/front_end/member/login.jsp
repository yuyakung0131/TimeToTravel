      ...
      <div class="col-sm-12">
         <nav>
            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
               <a class="nav-item nav-link " id="nav-regist-tab" data-toggle="tab" href="#nav-regist" role="tab"
                  aria-controls="nav-regist" aria-selected="false">註冊</a>
               <a class="nav-item nav-link active" id="nav-login-tab" data-toggle="tab" href="#nav-login" role="tab"
                  aria-controls="nav-profile" aria-selected="ture">登入</a>
            </div>
         </nav>
