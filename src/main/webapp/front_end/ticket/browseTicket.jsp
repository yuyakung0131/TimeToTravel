		...
		<section class="rooms-section spad">
			<div class="container">
				<div class="row">
					...
					<c:forEach var="tktimg" items="${set}" begin="<%=pageIndex%>"
						...
						<div class="col-lg-4 col-md-6">
							<div class="room-item">
								...
								<div class="ri-text">
									...
									<!-- 									<a href="/ticket_page_good.html" class="primary-btn">More -->
									<!-- 										Details</a>  -->
									<FORM METHOD="post" ACTION="ticket.do">
										<input type="submit" value="票券詳情" class="primary-btn">
